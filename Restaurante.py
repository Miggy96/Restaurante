...
operador = ''
precios_comida = [1.32, 1.65, 2.31, 3.22, 1.22, 5.99, 2.05, 6.65]
...
def  total():
    ...
    for cantidad in texto_bebida:
        sub_total_comida = sub_total_bebida + (float(cantidad.get()) * precios_bebida[p])
        p += 1 
...
def recibo():
    ...
    texto_recibo.insert(END, f'*' * 47 + '\n')
    texto_recibo.insert(END, 'Gracias por venir, lo esperamos pronto')
...
#panel calculadora
panel_calculadora = Frame(aplicacion, bd=1, relief=FLAT, bg='coral')
panel_calculadora.pack()

#panel recibo
panel_recibo = Frame(aplicacion, bd=1, relief=FLAT, bg='coral')
panel_recibo.pack()


#panel botones
panel_botones = Frame(aplicacion, bd=1, relief=FLAT, bg='coral')
panel_botones.pack()
...
lista_bebidas = ['agua', 'soda', 'jugo', 'cola', 'vino','vinoblanco', 'corona', 'aguila']
lista_postres = ['helado', 'fruta', 'brownies', 'flan', 'mousse', 'pastelmora', 'pastel de vainilla', 'pastel de fresa']
...
etiqueta_titulo = Label(panel_superior, text='Sistema de facturacion', fg='azure4', font=('Dosis', 58),
bg='burlywood', width=21)
